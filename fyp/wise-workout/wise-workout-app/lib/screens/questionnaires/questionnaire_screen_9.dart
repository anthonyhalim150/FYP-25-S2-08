...
class QuestionnaireScreen9 extends StatefulWidget {
  final int step;
  ...
  @override
  State<QuestionnaireScreen9> createState() => _QuestionnaireScreen9State();
}

class _QuestionnaireScreen9State extends State<QuestionnaireScreen9> {
  int selectedIndex = -1;
